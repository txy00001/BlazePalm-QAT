...
from .data_augment_new import resize_pad, resize_landmarks, draw_landmarks
...
if __name__ == "__main__":
    trainset_loader = PalmDatasetv1('/home/cmm/PycharmProjects/datas/handpose_datasets_v2')
    for i in range(trainset_loader.__len__()):
