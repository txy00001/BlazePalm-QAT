...
parser.add_argument('--training_dataset', default='/home/cmm/PycharmProjects/datas/handpose_datasets_v2', help='Training dataset directory')
...
parser.add_argument('--resume_net', default="weights/blazepalm_epoch_310.pth", help='resume net for retraining')
