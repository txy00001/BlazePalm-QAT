...
def detect():
    ...
    palm_detector.load_state_dict(torch.load(r"E:\project\qat\BlazePalm\weights\blazepalm_Final.pth", map_location=torch.device('cpu')))
    ...
    dataset_root = r'E:\project\qat\handpose_datasets_v2' 
